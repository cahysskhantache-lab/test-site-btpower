...
export const mediaConfig = {
  logos: {
    primary: {
      id: "logo-primary",
      path: "/images/Logo/bt-idf-logo-color-transparent.png",
      type: "logo",
      alt: "Logo officiel BT IDF",
      usage: "Header sur fond clair",
      source: "real",
    ...
    footer: {
      id: "logo-footer",
      path: "/images/Logo/bt-idf-logo-white-transparent.png",
      type: "logo",
      alt: "Logo officiel BT IDF en blanc",
      usage: "Footer et zones sombres",
      source: "real",
      publishApproved: true,
      width: 1000,
      height: 250
    ...
    contact: {
      id: "site-favicon",
      path: "/images/Logo/bt-idf-favicon-512.png",
      type: "logo",
      alt: "Icône BT IDF",
    ...
    mark: {
      id: "logo-mark",
      path: "/images/Logo/bt-idf-mark-green-transparent.png",
      type: "logo",
      alt: "Pictogramme éclair BT IDF",
  ...
  home: {
    hero: {
      ...
      type: "image",
      alt: "Collaborateur BT IDF travaillant sur le câblage en atelier",
      usage: "Accueil - hero",
      source: "real",
    ...
    videoMp4: {
      ...
      type: "video",
      alt: "Film de présentation BT IDF",
    ...
    videoMov: {
      ...
      type: "video",
      alt: "Film de présentation BT IDF au format MOV",
      usage: "Accueil - vidéo de présentation principale",
      source: "real",
      publishApproved: false,
  ...
  company: {
    group: {
      ...
      type: "image",
      alt: "Équipe BT IDF réunie devant l'atelier",
    ...
    work: {
      ...
      type: "image",
      alt: "Équipe BT IDF travaillant sur des équipements en atelier",
    ...
    study: {
      ...
      type: "image",
      alt: "Bureau d'études BT IDF en analyse de projet",
  ...
  method: [
    ...
    },
    {
      ...
      type: "image",
      alt: "Équipe BT IDF travaillant sur la fabrication d'un équipement électrique",
  ...
  afterSales: {
    ...
    type: "image",
    alt: "Interlocuteur BT IDF disponible par téléphone pour le suivi après livraison",
  ...
  trust: {
    ecovadisBronze: {
      ...
      type: "image",
      alt: "Médaille de bronze EcoVadis obtenue par BT IDF",
